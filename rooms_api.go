...
type ListRoomsQueryParams struct {
	...
	RoomType string `url:"type_,omitempty"`  // direct returns all 1-to-1 rooms. group returns all group rooms.
...
Long result sets will be split into pages.
 ...
 @param "RoomType" (string) direct returns all 1-to-1 rooms. group returns all group rooms.
